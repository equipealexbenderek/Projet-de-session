...
q1 = st.selectbox('En général, comment votre meilleur ami vous décrirait-il en tant que personne qui prend des risques?', q1_options)
...
q2 = st.selectbox('Vous participez à un jeu-questionnaire télévisé et vous pouvez choisir une option parmi les suivantes. Laquelle prendriez-vous?',q2_options)
...
q3 = st.selectbox('Vous avez enfin épargné l\'argent qu\'il vous fallait pour prendre les « vacances de votre vie ». Trois semaines avant votre départ, vous perdez votre boulot. Vous prenez une des décisions suivantes :', q3_options)
...
q5 = st.selectbox('Relativement à votre expérience, jusqu\'à quel point êtes-vous à l\'aise d investir dans des titres boursiers ou des fonds communs?',q5_options)
q6_options = ['Perte', 'Incertitude', 'Avantage', 'Frissons']
q6 = st.selectbox('Quand vous pensez au mot « risque », lequel des mots suivants vous vient immédiatement en tête?', q6_options)
...
q8 = st.selectbox('Lequel des quatre scénarios de placement ci-dessous choisiriez-vous?', q8_options)
q9_options = ['Un gain assuré de 500$', '50 % des chances de gagner 1 000 $ et 50 % des chances de ne rien gagner.']
q9 = st.selectbox('En plus de ce que vous possédez déjà, on vous a donné 1 000 $. On vous demande maintenant de choisir entre :', q9_options)
q10_options = ['Une perte assurée de 500 $', '50 % des chances de perdre 1 000 $ et 50 % des chances de ne rien perdre']
q10 = st.selectbox('En plus de ce que vous possédez déjà, on vous a donné 2 000 $. On vous demande maintenant de choisir entre :', q10_options)
...
q11 = st.selectbox('Supposons qu\'un de vos parents vous laisse un héritage de 100 000 $, stipulant dans son testament que devez investir TOUTE cette somme dans UN des outils suivants. Lequel choisissez-vous?',q11_options)
